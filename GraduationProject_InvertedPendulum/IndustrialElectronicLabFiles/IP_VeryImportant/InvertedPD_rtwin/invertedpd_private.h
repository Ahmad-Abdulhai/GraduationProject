...
#ifndef _RTW_HEADER_invertedpd_private_h_
# define _RTW_HEADER_invertedpd_private_h_
...
# error Model (invertedpd) was built in \
...
#endif                                  /* _RTW_HEADER_invertedpd_private_h_ */
