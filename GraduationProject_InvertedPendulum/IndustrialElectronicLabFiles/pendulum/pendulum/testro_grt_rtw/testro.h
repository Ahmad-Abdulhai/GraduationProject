...
#ifndef _RTW_HEADER_testro_h_
# define _RTW_HEADER_testro_h_

#include <limits.h>
#include "tmwtypes.h"
#ifndef _testro_COMMON_INCLUDES_
# define _testro_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
...
#endif                                  /* _testro_COMMON_INCLUDES_ */

#include "testro_types.h"

#define MODEL_NAME                      testro
...
typedef struct _BlockIO {
  ...
  real_T Proportional_a;                /* '<S3>/Proportional' */
  real_T D_a;                           /* '<S3>/D' */
  real_T Proportional_b;                /* '<S2>/Proportional' */
  real_T D_b;                           /* '<S2>/D' */
...
typedef struct D_Work_tag {
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Derivative_a_RWORK;                 /* '<S3>/Derivative' */
  struct {
    real_T TimeStampA;
    real_T LastUAtTimeA;
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Derivative_b_RWORK;                 /* '<S2>/Derivative' */
  struct {
    void *LoggedData;
...
typedef struct _ContinuousStates {
  real_T Integral_a_CSTATE;             /* '<S3>/Integral' */
  real_T Integral_b_CSTATE;             /* '<S2>/Integral' */
} ContinuousStates;
...
typedef struct _StateDisabled {
  boolean_T Integral_a_CSTATE;          /* '<S3>/Integral' */
  boolean_T Integral_b_CSTATE;          /* '<S2>/Integral' */
} StateDisabled;
...
struct _Parameters {
  ...
  real_T Step_YFinal;                   /* Expression: 0.2
                                         * '<Root>/Step'
                                         */
  real_T Gain4_Gain;                    /* Expression: 20
                                         * '<Root>/Gain4'
                                         */
...
extern rtModel_testro *const rtM_testro;
...
#define testro_rtModel                  rtModel_testro
 ...
 * '<Root>' : testro
 * '<S1>'   : testro/IP
 * '<S2>'   : testro/PID Controller
 * '<S3>'   : testro/PID Controller1
 * '<S4>'   : testro/IP/Scaling and Safety
 */

#endif                                  /* _RTW_HEADER_testro_h_ */
