...
#ifndef _RTW_HEADER_IP_State_FB_private_h_
# define _RTW_HEADER_IP_State_FB_private_h_
...
extern void pci1711FedEnc(SimStruct *rts);
extern void pci1711FedDac(SimStruct *rts);
extern int_T rt_CallSys(SimStruct *S, int_T element, int_T tid);

#if defined(MULTITASKING)
# error Model (IP_State_FB) was built in \
...
#endif                                  /* _RTW_HEADER_IP_State_FB_private_h_ */
