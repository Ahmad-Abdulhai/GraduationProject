/*
 * Real-Time Workshop code generation for Simulink model "IP_State_FB.mdl".
 *
 * Model Version                        : 1.72
 * Real-Time Workshop file version      : 5.0 $Date: 2002/05/30 19:21:33 $
 * Real-Time Workshop file generated on : Mon Mar 16 17:02:26 2009
 * TLC version                          : 5.0 (Jun 18 2002)
 * C source code generated on           : Mon Mar 16 17:02:26 2009
 */

#include <math.h>
#include <string.h>
#include "IP_State_FB.h"
#include "IP_State_FB_private.h"
#include "ext_work.h"

#include "IP_State_FB_dt.h"
#include "simstruc.h"
...
SimStruct *IP_State_FB(void)
{
  ...
  ssSetModelName(rtS, "IP_State_FB");
  ssSetPath(rtS, "IP_State_FB");
  ...
  ssSetChecksumVal(rtS, 0, 2541622563U);
  ssSetChecksumVal(rtS, 1, 1828469612U);
  ssSetChecksumVal(rtS, 2, 1818599293U);
  ssSetChecksumVal(rtS, 3, 2314824810U);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: IP_State_FB/<S1>/Read Cart Encoder1 (pci1711FedEnc) */
    {
      SimStruct *rts = ssGetSFunction(rtS, 0);
      /* timing info */
      ...
      ssSetPath(rts, "IP_State_FB/IP/Read Cart Encoder1");
    ...
    /* Level2 S-Function Block: IP_State_FB/<S1>/Read Pendulum Encoder (pci1711FedEnc) */
    {
      SimStruct *rts = ssGetSFunction(rtS, 1);
      /* timing info */
      static time_T sfcnPeriod[1];
      ...
      ssSetPath(rts, "IP_State_FB/IP/Read Pendulum Encoder");
      if (ssGetRTModel(rtS) == NULL) {
        ssSetParentSS(rts, rtS);
        ssSetRootSS(rts, ssGetRootSS(rtS));
      } else {
    ...
    /* Level2 S-Function Block: IP_State_FB/<S1>/Digital To Analog Converter (pci1711FedDac) */
    {
      SimStruct *rts = ssGetSFunction(rtS, 2);
      /* timing info */
      static time_T sfcnPeriod[1];
      ...
      ssSetPath(rts, "IP_State_FB/IP/Digital To Analog Converter");
      if (ssGetRTModel(rtS) == NULL) {
        ssSetParentSS(rts, rtS);
        ssSetRootSS(rts, ssGetRootSS(rtS));
      } else {
