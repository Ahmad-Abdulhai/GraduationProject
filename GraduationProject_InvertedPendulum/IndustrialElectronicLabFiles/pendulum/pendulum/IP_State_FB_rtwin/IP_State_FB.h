...
#ifndef _RTW_HEADER_IP_State_FB_h_
# define _RTW_HEADER_IP_State_FB_h_

#ifndef _IP_State_FB_COMMON_INCLUDES_
# define _IP_State_FB_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
...
#endif                                  /* _IP_State_FB_COMMON_INCLUDES_ */

#include "IP_State_FB_types.h"

#define MODEL_NAME                      IP_State_FB
...
struct _Parameters {
  ...
  real_T Step_Y0;                       /* Expression: 0
                                         * '<Root>/Step'
                                         */
  real_T Step_YFinal;                   /* Expression: 0.5
                                         * '<Root>/Step'
                                         */
  real_T Step1_Time;                    /* Expression: 10.2
                                         * '<Root>/Step1'
                                         */
 ...
 * '<Root>' : IP_State_FB
 * '<S1>'   : IP_State_FB/IP
 * '<S2>'   : IP_State_FB/IP/Scaling and Safety
 */

#endif                                  /* _RTW_HEADER_IP_State_FB_h_ */
