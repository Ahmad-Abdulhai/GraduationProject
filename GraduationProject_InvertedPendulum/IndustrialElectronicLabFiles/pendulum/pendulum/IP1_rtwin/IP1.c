...
void MdlOutputs(int_T tid)
{
  ...
  if (ssIsContinuousTask(rtS, tid)) {   /* Sample time: [0.0, 0.0] */
    ...
    rtb_actual_LoadPosition = (((130.0 * rtb_Sum1[1] ) + (35.0 * rtb_Sum1[3] ))
      + (((-45.0) * rtb_Sum1[0] ) + ((-30.0) * rtb_Sum1[2] ))) *
      rtP.Scaling_Gain;
...
SimStruct *IP1(void)
{
  ...
  ssSetChecksumVal(rtS, 0, 3566418525U);
  ssSetChecksumVal(rtS, 1, 1261137004U);
  ssSetChecksumVal(rtS, 2, 473857320U);
  ssSetChecksumVal(rtS, 3, 293192148U);
