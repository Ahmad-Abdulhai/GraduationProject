...
Parameters rtP = {
  ...
  /*  Pendulum_Velocity_Filter_A : '<S2>/Pendulum Velocity  Filter' */
  { -70.7, -10000.0 } ,
  /*  Pendulum_Velocity_Filter_C : '<S2>/Pendulum Velocity  Filter' */
  { 0.0, 10000.0 } ,
  /*  Cart_Velocity_Filter_A : '<S2>/Cart Velocity Filter' */
  { -70.7, -10000.0 } ,
  /*  Cart_Velocity_Filter_C : '<S2>/Cart Velocity Filter' */
  { 0.0, 10000.0 } ,
  20.0 ,                                /* Step_Time : '<Root>/Step' */
  ...
  2.5 ,                                 /* Saturation_UpperSat : '<S3>/Saturation' */
  -2.5                                  /* Saturation_LowerSat : '<S3>/Saturation' */
};
