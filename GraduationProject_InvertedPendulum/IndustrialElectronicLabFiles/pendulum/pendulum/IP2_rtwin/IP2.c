...
void MdlOutputs(int_T tid)
{
  ...
  if (ssIsContinuousTask(rtS, tid)) {   /* Sample time: [0.0, 0.0] */
     ...
     *   Expression: K3*u[3]
     */
    rtb_actual_LoadPosition = (((130.0 * rt_atan2( sin( rtb_Sum1[1] ) , cos(
      rtb_Sum1[1] ) ) ) + (35.0 * rtb_Sum1[3] )) + (((-40.0) * rtb_Sum1[0] ) +
      ((-80.0) * rtb_Sum1[2] ))) * rtP.Scaling_Gain;
...
SimStruct *IP2(void)
{
  ...
  ssSetChecksumVal(rtS, 0, 223994968U);
  ssSetChecksumVal(rtS, 1, 2363804595U);
  ssSetChecksumVal(rtS, 2, 3244368467U);
  ssSetChecksumVal(rtS, 3, 589313575U);
