 ...
 * '<S3>'   : InvertedPD/Control Subsystem/Controller
 * '<S4>'   : InvertedPD/Control Subsystem/Controller/Friction Compensation
 * '<S5>'   : InvertedPD/Control Subsystem/Controller/Linear cart controller
 * '<S6>'   : InvertedPD/Control Subsystem/Controller/Linear pendulum controller
 */
