...
#define NBLOCKIO                        (14)                     /* Number of data output port signals */
...
typedef struct _BlockIO {
  ...
  real_T Look_Up_Table_n_D;             /* '<S4>/Look-Up Table (n-D)' */
  real_T Memory_a;                      /* '<S4>/Memory' */
  real_T fuzzy_Look_Up;                 /* '<S5>/fuzzy Look-Up ' */
...
struct _Parameters {
  ...
  real_T Constant3_Value;               /* Expression: 0
                                         * '<S1>/Constant3'
                                         */
  real_T Look_Up_Table_n_D_tableData[6561]; /* Expression: tableData
                                             * '<S4>/Look-Up Table (n-D)'
                                             */
  real_T Look_Up_Table_n_D_bp01Data[81]; /* Expression: bp1
                                          * '<S4>/Look-Up Table (n-D)'
                                          */
  real_T Look_Up_Table_n_D_bp02Data[81]; /* Expression: bp2
                                          * '<S4>/Look-Up Table (n-D)'
                                          */
  ...
  real_T Memory_a_X0;                   /* Expression: 0
                                         * '<S4>/Memory'
                                         */
  real_T fuzzy_Look_Up_tableData[6561]; /* Expression: tableData
                                         * '<S5>/fuzzy Look-Up '
                                         */
  real_T fuzzy_Look_Up_bp01Data[81];    /* Expression: bp1
                                         * '<S5>/fuzzy Look-Up '
                                         */
  real_T fuzzy_Look_Up_bp02Data[81];    /* Expression: bp2
                                         * '<S5>/fuzzy Look-Up '
                                         */
  ...
  real_T Saturation_LowerSat;           /* Expression: -2.5
                                         * '<S2>/Saturation'
                                         */
  int32_T Look_Up_Table_n_D_maxIndex[2]; /* Computed Parameter: maxIndex
                                          * '<S4>/Look-Up Table (n-D)'
                                          */
  int32_T fuzzy_Look_Up_maxIndex[2];    /* Computed Parameter: maxIndex
                                         * '<S5>/fuzzy Look-Up '
                                         */
};
