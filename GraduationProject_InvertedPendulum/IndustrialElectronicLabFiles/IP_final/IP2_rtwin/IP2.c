...
void MdlOutputs(int_T tid)
{
  ...
  if (ssIsContinuousTask(rtS, tid)) {   /* Sample time: [0.0, 0.0] */
     ...
     *
     * Regarding '<S4>/Fcn1':
     *   Expression: -40*u[1]/u1
     *
     * Regarding '<S4>/Fcn2':
     *   Expression: -80*u[3]/u1
     */

    /* Look-Up Table (2-D): '<S4>/Look-Up Table (n-D)' */
    rtB.Look_Up_Table_n_D = rt_LookLin2BinXZd((( -40.0) * rtb_Sum1[0] / 1.0), ((
      -80.0) * rtb_Sum1[2] / 1.0), rtP.Look_Up_Table_n_D_bp01Data,
      rtP.Look_Up_Table_n_D_bp02Data, rtP.Look_Up_Table_n_D_tableData,
  ...
  if (ssIsContinuousTask(rtS, tid)) {   /* Sample time: [0.0, 0.0] */
    ...
    /* S-Function (sfun_lookupnd): '<S5>/fuzzy Look-Up ' incorporates:
     *   Fcn: '<S5>/Fcn3'
     *   Fcn: '<S5>/Fcn2'
     *
     * Regarding '<S5>/Fcn3':
     *   Expression: 130*u[2]/u2
     *
     * Regarding '<S5>/Fcn2':
     *   Expression: 35*u[4]/u2
     */

    /* Look-Up Table (2-D): '<S5>/fuzzy Look-Up ' */
    rtB.fuzzy_Look_Up = rt_LookLin2BinXZd((130.0 * rtb_Sum1[1] / 1.0), (35.0 *
      rtb_Sum1[3] / 1.0), rtP.fuzzy_Look_Up_bp01Data,
      rtP.fuzzy_Look_Up_bp02Data, rtP.fuzzy_Look_Up_tableData,
  ...
  if (ssIsContinuousTask(rtS, tid)) {   /* Sample time: [0.0, 0.0] */
     ...
     */
    rtb_actual_LoadPosition = (((rtB.fuzzy_Look_Up * rtP.Gain2_b_Gain) +
      rtB.Memory_b) + ((rtB.Look_Up_Table_n_D * rtP.Gain2_a_Gain) +
      rtB.Memory_a)) * rtP.Scaling_Gain;
...
void MdlUpdate(int_T tid)
{
  ...
  if (ssIsSampleHit(rtS, 1, tid)) {     /* Sample time: [0.001, 0.0] */
    ...
    /* Memory Block: <S4>/Memory */
    rtDWork.Memory_a_PreviousInput = rtB.Look_Up_Table_n_D;

    /* Memory Block: <S5>/Memory */
    rtDWork.Memory_b_PreviousInput = rtB.fuzzy_Look_Up;
  }
...
void MdlInitializeSizes(void)
{
  ...
  ssSetNumBlockIO(rtS, 14);             /* Number of block outputs */
  ssSetNumBlockParams(rtS, 13509);      /* Sum of parameter "widths" */
}
...
SimStruct *IP2(void)
{
  ...
  ssSetChecksumVal(rtS, 0, 4086371691U);
  ssSetChecksumVal(rtS, 1, 1795036303U);
  ssSetChecksumVal(rtS, 2, 1292260853U);
  ssSetChecksumVal(rtS, 3, 196811862U);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: IP2/<Root>/Digital To Analog Converter (pci1711FedDac) */
    {
      SimStruct *rts = ssGetSFunction(rtS, 0);
      /* timing info */
      ...
      ssSetPath(rts, "IP2/Digital To Analog Converter");
    ...
    /* Level2 S-Function Block: IP2/<Root>/Read Cart Encoder1 (pci1711FedEnc) */
    {
      SimStruct *rts = ssGetSFunction(rtS, 1);
      /* timing info */
      static time_T sfcnPeriod[1];
      ...
      ssSetPath(rts, "IP2/Read Cart Encoder1");
      if (ssGetRTModel(rtS) == NULL) {
        ssSetParentSS(rts, rtS);
        ssSetRootSS(rts, ssGetRootSS(rtS));
      } else {
    ...
    /* Level2 S-Function Block: IP2/<Root>/Read Pendulum Encoder (pci1711FedEnc) */
    {
      SimStruct *rts = ssGetSFunction(rtS, 2);
      /* timing info */
      static time_T sfcnPeriod[1];
      ...
      ssSetPath(rts, "IP2/Read Pendulum Encoder");
      if (ssGetRTModel(rtS) == NULL) {
        ssSetParentSS(rts, rtS);
        ssSetRootSS(rts, ssGetRootSS(rtS));
      } else {
