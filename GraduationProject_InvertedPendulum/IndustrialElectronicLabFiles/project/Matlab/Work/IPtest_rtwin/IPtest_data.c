...
Parameters rtP = {
  ...
  { 1.0, 1.0 } ,
  1.0 ,                                 /* Read_Cart_Encoder1_P1 : '<Root>/Read Cart Encoder1' */
  ...
  { 1.0, 1.0 } ,
  0.0 ,                                 /* Read_Pendulum_Encoder_P1 : '<Root>/Read Pendulum Encoder' */
  /*  Read_Pendulum_Encoder_P2_Size : '<Root>/Read Pendulum Encoder' */
  { 1.0, 1.0 } ,
  0.0 ,                                 /* Read_Pendulum_Encoder_P2 : '<Root>/Read Pendulum Encoder' */
