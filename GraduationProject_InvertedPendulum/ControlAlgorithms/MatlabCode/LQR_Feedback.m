...
mpw = 0.095;
mps = 0.025;
l = 0.033245968; % 0.0167903;
fc = 2.53165; % FS = 2.53165; FC = 2.28133
fp = 0.000107443;
J = 0.013935418; % 0.0135735;
g = 9.81;
vf = 9.4/2.5; % Voltage to Motor Force ratio % 17.463
mp = mpw + mps;
a = l^2 + J/(mc + mp);
mu = (mc + mp)*l;
...
Q = diag([4000, 10000, 1000, 1]) % Try [50 100 1 1][1],[800 1000 10 100][1],[800, 2000, 5000, 500][1],[9000 8000 7000 100][10]
R = 10;
[K, S, e] = lqr(A,B,Q,R)
