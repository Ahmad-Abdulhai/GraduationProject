...
double x_k_1, o_k_1, v_k_1, w_k_1, Uv, x_m, o_m;
...
int    i,j,k;
double  mc, mpw, mps, l, fc , fp, J, g, vf, mp, a, mu, errorx, erroro, sum, del;
...
Pk_k[0][0]=1.0;///100;  //  related to x
Pk_k[0][1]=0.0;
Pk_k[0][2]=0.0;
Pk_k[0][3]=0.0;

Pk_k[1][0]=0.0;
Pk_k[1][1]=1.0;////100;       related to Wr
Pk_k[1][2]=0.0;
Pk_k[1][3]=0.0;
...
R[0][0]=1e-03; R[0][1]=0.0;
R[1][0]=0.0;   R[1][1]=1e-03;

Q[0][0]=1; Q[0][1]=0; Q[0][2]=0; Q[0][3]=0; // 1e-02
Q[1][0]=0; Q[1][1]=1; Q[1][2]=0; Q[1][3]=0; // 1e-03
Q[2][0]=0; Q[2][1]=0; Q[2][2]=1e-02; Q[2][3]=0;     // 3
Q[3][0]=0; Q[3][1]=0; Q[3][2]=0; Q[3][3]=1e-02;   // 2.6
...
x_es_k[0]=0.0;
x_es_k[1]=0.0; // 3.141592653589793;
x_es_k[2]=0.0;
x_es_k[3]=0.0;
...
x_k_1 = x_es_k[0]+K_g[0][0]*errorx+K_g[0][1]*erroro; // x_k_1
o_k_1 = x_es_k[1]+K_g[1][0]*errorx+K_g[1][1]*erroro; // o_k_1
v_k_1 = x_es_k[2]+K_g[2][0]*errorx+K_g[2][1]*erroro; // v_k_1
w_k_1 = x_es_k[3]+K_g[3][0]*errorx+K_g[3][1]*erroro; // w_k_1
