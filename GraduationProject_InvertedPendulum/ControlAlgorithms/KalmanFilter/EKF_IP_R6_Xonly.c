...
int    i,j,k;
double  mc, mpw, mps, l, fc , fp, J, g, vf, mp, a, mu, errorx, sum, del;
...
// System Parameters
    ...
    Q[0][0]=10; Q[0][1]=0; Q[0][2]=0; Q[0][3]=0;
    Q[1][0]=0; Q[1][1]=1e-02; Q[1][2]=0; Q[1][3]=0;
    Q[2][0]=0; Q[2][1]=0; Q[2][2]=10; Q[2][3]=0;
    Q[3][0]=0; Q[3][1]=0; Q[3][2]=0; Q[3][3]=1e-02;
...
////////////////Kalman Filter Gain Calculation//////////
    ...
    
    {
        ...
        HPH_R[0][0]=H_Pk_H_T[0][0]+R[0][0]; // H(k)*P(-)*H(k)' + R
...
x_k_1 = x_es_k[0]+K_g[0][0]*errorx; // x_k_1
o_k_1 = x_es_k[1]+K_g[1][0]*errorx; // o_k_1
v_k_1 = x_es_k[2]+K_g[2][0]*errorx; // v_k_1
w_k_1 = x_es_k[3]+K_g[3][0]*errorx; // w_k_1
