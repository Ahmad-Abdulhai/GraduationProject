...
Pk_k[0][0]=1000;///100;  //  related to ia
Pk_k[0][1]=0.0;
Pk_k[0][2]=0.0;
Pk_k[0][3]=0.0;

Pk_k[1][0]=0.0;
Pk_k[1][1]=1000;////100;       related to Wr
Pk_k[1][2]=0.0;
Pk_k[1][3]=0.0;
...
R[0][0]=0.0001; R[0][0]=0.0;
R[0][0]=0.0;   R[0][0]=0.001;

Q[0][0]=6000; Q[0][1]=0; Q[0][2]=0; Q[0][3]=0;
Q[1][0]=0; Q[1][1]=800; Q[1][2]=0; Q[1][3]=0;
Q[2][0]=0; Q[2][1]=0; Q[2][2]=12000; Q[2][3]=0;
Q[3][0]=0; Q[3][1]=0; Q[3][2]=0; Q[3][3]=600;
