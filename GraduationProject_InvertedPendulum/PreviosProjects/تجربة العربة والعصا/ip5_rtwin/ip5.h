...
#ifndef _RTW_HEADER_ip5_h_
# define _RTW_HEADER_ip5_h_

#ifndef _ip5_COMMON_INCLUDES_
# define _ip5_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
...
#endif                                  /* _ip5_COMMON_INCLUDES_ */

#include "ip5_types.h"

#define MODEL_NAME                      ip5
 ...
 *
 * '<Root>' : ip5
 * '<S1>'   : ip5/Control Subsystem
 * '<S2>'   : ip5/Scaling and Safety
 * '<S3>'   : ip5/Signal Builder
 * '<S4>'   : ip5/Control Subsystem/Controller
 * '<S5>'   : ip5/Control Subsystem/Controller/Linear cart controller
 * '<S6>'   : ip5/Control Subsystem/Controller/Linear pendulum controller
 */

#endif                                  /* _RTW_HEADER_ip5_h_ */
