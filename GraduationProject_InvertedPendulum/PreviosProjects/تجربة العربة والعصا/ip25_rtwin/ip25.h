...
#ifndef _RTW_HEADER_ip25_h_
# define _RTW_HEADER_ip25_h_

#ifndef _ip25_COMMON_INCLUDES_
# define _ip25_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
...
#endif                                  /* _ip25_COMMON_INCLUDES_ */

#include "ip25_types.h"

#define MODEL_NAME                      ip25
 ...
 *
 * '<Root>' : ip25
 * '<S1>'   : ip25/Control Subsystem
 * '<S2>'   : ip25/Scaling and Safety
 * '<S3>'   : ip25/Signal Builder
 * '<S4>'   : ip25/Control Subsystem/Controller
 * '<S5>'   : ip25/Control Subsystem/Controller/Linear cart controller
 * '<S6>'   : ip25/Control Subsystem/Controller/Linear pendulum controller
 */

#endif                                  /* _RTW_HEADER_ip25_h_ */
