...
void MdlOutputs(int_T tid)
{
  ...
  if (ssIsSampleHit(rtS, 1, tid)) {     /* Sample time: [0.001, 0.0] */
     ...
     *   Lower limit: rtP.Saturation_a_LowerSat
     *   Upper limit: rtP.Saturation_a_UpperSat
     */
    if (0.0 >= rtP.Saturation_a_UpperSat) {
      rtb_Saturation_a = rtP.Saturation_a_UpperSat;
    } else if (0.0 <= rtP.Saturation_a_LowerSat) {
      rtb_Saturation_a = rtP.Saturation_a_LowerSat;
    } else {
      rtb_Saturation_a = 0.0;
    }
  ...
  if (ssIsContinuousTask(rtS, tid)) {   /* Sample time: [0.0, 0.0] */
     ...
     */
    rtb_temp23 = (rtb_Step * (rtb_Clock - rtP.Constant_Value))
      + rtP.Constant1_a_Value;
     ...
     */
    if (rtb_temp23 >= rtP.Saturation1_UpperSat) {
      rtB.Saturation1 = rtP.Saturation1_UpperSat;
    } else if (rtb_temp23 <= rtP.Saturation1_LowerSat) {
      rtB.Saturation1 = rtP.Saturation1_LowerSat;
    } else {
      rtB.Saturation1 = rtb_temp23;
    }
  ...
  if (ssIsContinuousTask(rtS, tid)) {   /* Sample time: [0.0, 0.0] */
     ...
     */
    rtb_Sum1_b[0] = - rtB.Cart_Position + rtB.Saturation1;
    rtb_Sum1_b[1] = - rtB.Pendulum_Position + rtP.Constant1_b_Value;
    rtb_Sum1_b[2] = - rtB.Cart_Velocity + rtP.Constant2_Value;
    rtb_Sum1_b[3] = - rtB.Pendulum_Velocity + rtP.Constant3_Value;
     ...
     *   Expression: K3*u[3]
     */
    rtb_temp23 = (((130.0 * rtb_Sum1_b[1] ) + (35.0 * rtb_Sum1_b[3] )) +
      (((-45.0) * rtb_Sum1_b[0] ) + ((-80.0) * rtb_Sum1_b[2] ))) *
      rtP.Scaling_Gain;

    /* Saturate: '<S3>/Saturation'
     *
     * Regarding '<S3>/Saturation':
     *   Lower limit: rtP.Saturation_b_LowerSat
     *   Upper limit: rtP.Saturation_b_UpperSat
     */
    if (rtb_temp23 >= rtP.Saturation_b_UpperSat) {
      rtB.Saturation_b = rtP.Saturation_b_UpperSat;
    } else if (rtb_temp23 <= rtP.Saturation_b_LowerSat) {
      rtB.Saturation_b = rtP.Saturation_b_LowerSat;
    } else {
      rtB.Saturation_b = rtb_temp23;
    }
  }
}
...
void MdlInitializeSizes(void)
{
  ...
  ssSetNumBlockParams(rtS, 61);         /* Sum of parameter "widths" */
}
...
SimStruct *IP1(void)
{
  ...
  ssSetChecksumVal(rtS, 0, 3801237142U);
  ssSetChecksumVal(rtS, 1, 94985246U);
  ssSetChecksumVal(rtS, 2, 197404617U);
  ssSetChecksumVal(rtS, 3, 4121810477U);
