...
#ifndef _RTW_HEADER_IP1_h_
# define _RTW_HEADER_IP1_h_

#ifndef _IP1_COMMON_INCLUDES_
# define _IP1_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
...
#endif                                  /* _IP1_COMMON_INCLUDES_ */

#include "IP1_types.h"

#define MODEL_NAME                      IP1
...
typedef struct _BlockIO {
  ...
  real_T Saturation_b;                  /* '<S3>/Saturation' */
} BlockIO;
...
struct _Parameters {
  real_T Saturation_a_UpperSat;         /* Expression: 0.5
                                         * '<Root>/Saturation'
                                         */
  real_T Saturation_a_LowerSat;         /* Expression: -0.5
                                         * '<Root>/Saturation'
                                         */
  ...
  real_T Step_YFinal;                   /* Expression: slope
                                         * '<S2>/Step'
                                         */
  real_T Constant_Value;                /* Expression: start
                                         * '<S2>/Constant'
                                         */
  real_T Constant1_a_Value;             /* Expression: X0
                                         * '<S2>/Constant1'
                                         */
  real_T Saturation1_UpperSat;          /* Expression: 0.1
                                         * '<Root>/Saturation1'
                                         */
  ...
  real_T Pendulum_Velocity_Filter_C[2]; /* Computed Parameter: C
                                         * '<S1>/Pendulum Velocity  Filter'
                                         */
  real_T Constant1_b_Value;             /* Expression: pi
                                         * '<S1>/Constant1'
                                         */
  ...
  real_T Scaling_Gain;                  /* Expression: 1
                                         * '<S3>/Scaling'
                                         */
  real_T Saturation_b_UpperSat;         /* Expression: 2.5
                                         * '<S3>/Saturation'
                                         */
  real_T Saturation_b_LowerSat;         /* Expression: -2.5
                                         * '<S3>/Saturation'
                                         */
};
 ...
 *
 * '<Root>' : IP1
 * '<S1>'   : IP1/Control Subsystem
 * '<S2>'   : IP1/Ramp
 * '<S3>'   : IP1/Scaling and Safety
 * '<S4>'   : IP1/Control Subsystem/Controller
 * '<S5>'   : IP1/Control Subsystem/Controller/Linear cart controller
 * '<S6>'   : IP1/Control Subsystem/Controller/Linear pendulum controller
 */

#endif                                  /* _RTW_HEADER_IP1_h_ */
