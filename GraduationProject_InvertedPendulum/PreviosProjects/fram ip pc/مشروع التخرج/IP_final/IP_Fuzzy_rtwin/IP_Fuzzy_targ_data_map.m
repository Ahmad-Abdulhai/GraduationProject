  ...
  ;%***********************
	...
	;% rtP.Look_Up_Table_n_D_a_tableData
	section.data(33).logicalSrcIdx = 32;
	section.data(33).dtTransOffset = 44;
	
	;% rtP.Look_Up_Table_n_D_a_bp01Data
	section.data(34).logicalSrcIdx = 33;
	section.data(34).dtTransOffset = 6605;
	
	;% rtP.Look_Up_Table_n_D_a_bp02Data
	section.data(35).logicalSrcIdx = 34;
	section.data(35).dtTransOffset = 6686;
	
	;% rtP.Gain2_a_Gain
	section.data(36).logicalSrcIdx = 35;
	section.data(36).dtTransOffset = 6767;
	
	;% rtP.Memory_a_X0
	section.data(37).logicalSrcIdx = 36;
	section.data(37).dtTransOffset = 6768;
	
	;% rtP.Gain_b_Gain
	section.data(38).logicalSrcIdx = 37;
	section.data(38).dtTransOffset = 6769;
	
	;% rtP.Gain1_b_Gain
	section.data(39).logicalSrcIdx = 38;
	section.data(39).dtTransOffset = 6770;
	
	;% rtP.Look_Up_Table_n_D_b_tableData
	section.data(40).logicalSrcIdx = 39;
	section.data(40).dtTransOffset = 6771;
	
	;% rtP.Look_Up_Table_n_D_b_bp01Data
	section.data(41).logicalSrcIdx = 40;
	section.data(41).dtTransOffset = 13332;
	
	;% rtP.Look_Up_Table_n_D_b_bp02Data
	section.data(42).logicalSrcIdx = 41;
	section.data(42).dtTransOffset = 13413;
	
	;% rtP.Gain2_b_Gain
	section.data(43).logicalSrcIdx = 42;
	section.data(43).dtTransOffset = 13494;
	
	;% rtP.Memory_b_X0
	section.data(44).logicalSrcIdx = 43;
	section.data(44).dtTransOffset = 13495;
	
	;% rtP.Scaling_Gain
	section.data(45).logicalSrcIdx = 44;
	section.data(45).dtTransOffset = 13496;
	
	;% rtP.Saturation_UpperSat
	section.data(46).logicalSrcIdx = 45;
	section.data(46).dtTransOffset = 13497;
	
	;% rtP.Saturation_LowerSat
	section.data(47).logicalSrcIdx = 46;
	section.data(47).dtTransOffset = 13498;
  ...
  targMap.checksum0 = 1956683916;
  targMap.checksum1 = 1148969180;
  targMap.checksum2 = 716391119;
  targMap.checksum3 = 1502320611;
