 ...
 * '<S3>'   : IP2/Signal Builder
 * '<S4>'   : IP2/Control Subsystem/Controller
 * '<S5>'   : IP2/Control Subsystem/Controller/Linear cart controller
 * '<S6>'   : IP2/Control Subsystem/Controller/Linear pendulum controller
 */
