/*
 * Real-Time Workshop code generation for Simulink model "ip5.mdl".
 *
 * Model Version                        : 1.87
 * Real-Time Workshop file version      : 5.0 $Date: 2002/05/30 19:21:33 $
 * Real-Time Workshop file generated on : Thu Jan 01 02:47:11 2004
 * TLC version                          : 5.0 (Jun 18 2002)
 * C source code generated on           : Thu Jan 01 02:47:11 2004
 */

#include <math.h>
#include <string.h>
#include "ip5.h"
#include "ip5_private.h"
#include "ext_work.h"
...
SimStruct *ip5(void)
{
  ...
  ssSetChecksumVal(rtS, 0, 2697694222U);
  ssSetChecksumVal(rtS, 1, 4033780908U);
  ssSetChecksumVal(rtS, 2, 1667736381U);
  ssSetChecksumVal(rtS, 3, 3524575117U);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: ip5/<Root>/Digital To Analog Converter (pci1711FedDac) */
    {
      SimStruct *rts = ssGetSFunction(rtS, 0);
      /* timing info */
      ...
      ssSetPath(rts, "ip5/Digital To Analog Converter");
    ...
    /* Level2 S-Function Block: ip5/<Root>/Read Cart Encoder1 (pci1711FedEnc) */
    {
      SimStruct *rts = ssGetSFunction(rtS, 1);
      /* timing info */
      static time_T sfcnPeriod[1];
      ...
      ssSetPath(rts, "ip5/Read Cart Encoder1");
      if (ssGetRTModel(rtS) == NULL) {
        ssSetParentSS(rts, rtS);
        ssSetRootSS(rts, ssGetRootSS(rtS));
      } else {
    ...
    /* Level2 S-Function Block: ip5/<Root>/Read Pendulum Encoder (pci1711FedEnc) */
    {
      SimStruct *rts = ssGetSFunction(rtS, 2);
      /* timing info */
      static time_T sfcnPeriod[1];
      ...
      ssSetPath(rts, "ip5/Read Pendulum Encoder");
      if (ssGetRTModel(rtS) == NULL) {
        ssSetParentSS(rts, rtS);
        ssSetRootSS(rts, ssGetRootSS(rtS));
      } else {
